...
public class UserController {
    ...
    // 본인이 본인 정보 수정
    @PatchMapping
    @Operation(summary = "유저 수정", description = "특정 유저에 대한 정보 수정", security = @SecurityRequirement(name = "bearerAuth"))
    ...
    // 본인이 본인 탈퇴
    @DeleteMapping
    @Operation(summary = "유저 삭제", description = "특정 유저 탈퇴", security = @SecurityRequirement(name = "bearerAuth"))
